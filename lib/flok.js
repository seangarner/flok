...
function Flok(o) {
  ...
  if (o.builtInLock === true) this.extend(require('./lock-file'));
  if (o.builtInStatus === true) this.extend(require('./status-file'));
}
...
Flok.prototype.down = function down(ts, done) {
  ...
  async.auto({
    ...
    executeMigrations: ['blockedMigrations', function (callback) {
      var migration = filter(self.migrations, 'isDone').shift();
